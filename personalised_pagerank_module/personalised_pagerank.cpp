...
//int main() {
//    int start = std::clock();
//    std::cout << "Page Rank is !" << std::endl;
////    personalised_pagerank_alg::PageRankGraph reza(1,0,{});
//    personalised_pagerank_alg::PageRankGraph reza(0,0,{});
////    std::vector<std::pair<int, double>> p = {{3, 1}};
//    auto reza1 = personalised_pagerank_alg::ParallelIterativePageRank(reza);
//    for (auto i: reza1) { std::cout << i << "  "; };
//    std::cout << "" << std::endl;
//    int end = std::clock();
